...
- можно добавлять слова в excluded, и заголовки, содержащие их, не будут отображаться
...
- можно скопировать файл базы данных в любое удобное место на компьютере и указать путь к нему в settings (я так делаю для синхронизации между компьютерами)
